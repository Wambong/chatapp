...
function initializeWebSocket() {
    ...
    socket.onopen = async function (e) {
        ...
        send_message_form.on('submit', function (e) {
            ...
            let data = {
                'message': message || "", // If message is empty, set it as an empty string
            ...
            if (mediaFile) {
                ...
                reader.onload = function (event) {
                    ...
                    // Convert the data object to a JSON string before sending it
    ...
    socket.onerror = async function (e) {
        ...
        // Handle the error (e.g., reconnect)
...
//                    </div>
//                    <div class="img_cont_msg">
//                        <img src="data:image/jpeg;base64,/9j/4AAQS=" class="rounded-circle user_img_msg">
//                    </div>
//                </div>
//            `;
//        } else {
